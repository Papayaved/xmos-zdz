...
# code section
	...
	.globl		sinc3
	.globl		sinc3.nstackwords
	.linkset	sinc3.nstackwords, 2
	.globl		sinc3.maxthreads
	.linkset	sinc3.maxthreads, 0
	.globl		sinc3.maxtimers
	.linkset	sinc3.maxtimers, 0
	.globl		sinc3.maxchanends
	.linkset	sinc3.maxchanends, 1

	.cc_top		sinc3.function, sinc3
sinc3:
	extsp	2
	stw		r0, sp[1]
	stw		r1, sp[2]
...
.L40:
	...
	ldw		r0, sp[2]
	out		res[r0], r1		# result

	bu		loop

	.cc_bottom	sinc3.function
